...
const Structure = ({ title , description, numOfJobs ,categoryone , categorytwo }: StructurProps) => {
  return (
      ...
      <div className="flex h-screen">
        <div className="bg-white shadow-lg rounded-lg w-4/5 h-3/5 flex ">
          <div className="w-20% px-8 text-gray-600 ">
            <p className="mt-10">
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSUa5M05HGFJDvdcxyPXFRDELelBkONTI1aUA&s" alt="myimage" width={400} height={300} />
